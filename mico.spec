...
Biblioteka ta dostarcza w pełni sprawną i międzyplatformową
implementację standardu CORBA 2.3.
...
Zawiera niezbędne pliki do tworzenia i kompilacji aplikacji
korzystających z MICO, takie jak pliki nagłówkowe oraz dokumentację.
